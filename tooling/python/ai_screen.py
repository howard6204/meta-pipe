#!/usr/bin/env python3
"""
AI-powered title/abstract screening for meta-analysis projects.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="AI-powered title/abstract screening for any meta-analysis project"
    )
